  ...
  for (const company of companies) {
    ...
    try {
      await resend.emails.send({
        ...
        to: emails,
        subject: `Your ${new Date().toLocaleDateString("en-IE", { month: "long" })} GnóRate summary is ready`,
        html: `
        ...
        `,
        text: `Your monthly GnóRate summary is ready — log in to view it: https://wattpryce.com/dashboard`,
      });
      emailsSent++;
    } catch (e) {
