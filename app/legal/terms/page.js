  ...
  return (
    <div style={wrap}>
      ...
      <div style={inner}>
        ...
        <p style={p}>
          This is a plain-language summary of the terms for using GnóRate, a tool for tracking energy contract
        ...
        <h2 style={h2}>What GnóRate is</h2>
        <p style={p}>
          GnóRate lets you track electricity and gas accounts, upload bills for automatic data extraction, and see
        ...
        <p style={p}>
          Don't use GnóRate to upload content you don't have the right to use, to attempt to access other companies'
        ...
        <p style={p}>
          GnóRate is provided "as is," without warranty of any kind. We aim to keep the service running reliably but
