  ...
  return (
    <div style={wrap}>
      ...
      <div style={inner}>
        ...
        <p style={p}>
          This is a plain-language account of what data GnóRate collects and why. It is not a substitute for
        ...
        <p style={p}>A few external services are used to run GnóRate:</p>
        <ul style={{ paddingLeft: 20 }}>
        ...
        <p style={p}>
          ...
          across different companies using GnóRate.
        </p>
